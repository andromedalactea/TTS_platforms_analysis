...
ssml = """<speak version='1.0' xml:lang='en-US' xmlns='http://www.w3.org/2001/10/synthesis' xmlns:mstts='http://www.w3.org/2001/mstts'>
    <voice name='{}'>
        ...
        The rainbow has seven colors: <mark name="1"/>Red, orange, yellow,<mark name="2"/> green,<mark name="3"/> blue, indigo, and violet.
    </voice>
...
print("Speech synthesis result: {}".format(speech_synthesis_result))
