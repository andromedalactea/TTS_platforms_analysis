...
if __name__ == '__main__':
    directory = '/home/andromedalactea/test/google/autput_audios/Is_it_Ready?'
    merge_audios_with_pause(directory, 'spaced', '/home/andromedalactea/test/google/autput_audios/output.wav')
